...
@section('content')
    ...
    <section class="menu-hero">
        <div class="container-ww">
            ...
            <p>Discover our handcrafted selection of pillowy donuts, from timeless classics to seasonal specials, baked
                fresh daily with home-baked warmth.</p>
        </div>
    </section>
    ...
    <div class="container-ww">
        ...
        <section class="section" style="padding-top:0;">
            <div class="menu-grid">
                ...
                @empty
                    <p style="grid-column: 1/-1; text-align:center; color:#8A7C72;">No menu items match your search.</p>
                @endforelse
            </div>
        </section>
